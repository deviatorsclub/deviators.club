export const iosResources = [
  {
    ...
    goal: "Follow a structured path to learn iOS development step by step, ensuring you cover all essential skills and technologies.",
  },
  {
    ...
    goal: "Build a strong foundation in Swift and Xcode to start developing full-featured iOS, macOS, and watchOS apps confidently.",
  },
  {
    ...
    goal: "Gain a deep understanding of how to use SwiftUI to design and implement responsive and modern user interfaces across Apple platforms.",
  ...
  },
  {
    ...
    goal: "Learn practical app-building techniques by exploring real-world SwiftUI samples and observing how Apple engineers structure apps.",
  },
  {
    name: "Develop Apps for Apple Platforms",
    ...
    goal: "Develop the foundational skills required to design, build, and polish apps for iPhone, iPad, and beyond.",
    estimatedTime: "16 hr 40 min",
  },
  {
    name: "Profiling Apps Using Instruments",
    ...
    goal: "Master performance analysis with Instruments to ensure your apps are efficient, smooth, and reliable.",
